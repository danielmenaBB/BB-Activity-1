...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        categories.add("Aseo");
        InmutableProduct inmutableProduct = new InmutableProduct("Fabuloso moradito", "Dersa", categories);
        ...
        MutableProduct puntoUnoMutableProduct = new MutableProduct("Fabuloso moradito", "Dersa", categoriesMutable);
